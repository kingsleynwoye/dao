...
contract DAO {
    ...
    mapping(bytes32 => mapping(bytes32 => bool)) public votes;
    ...
    function createProposal(bytes32 proposalHash) external {
        ...
        require(proposals[proposalHash].hash == bytes32(0), 'proposal already exit');
    ...
    function vote(bytes32 proposalHash, Side side) external {
        ...
        require(block.timestamp <= proposal.createdAt + VOTING_PERIOD, 'voting period owner');
